            ...
            <form>
                <div class="form-group">
                    <div class="input-group justify-content-center" id ='search'>
                        <input type="text" class="form-control searchInput" id="searchInput", placeholder="Discover the location at the map">
                        <div class="dropdown-menu" id="results"></div>
                        <button type="button" class="btn btn-custom btn-block search-button" id="findButton">Find</button>
                    </div>
                </div>
